...
from config import sizeh_b,sizew_b,max,minim,normal


class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.size_w,self.size_h = normal
        self.sizew_b = sizew_b
        self.sizeh_b = sizeh_b
        self.numb = 3
